...
<main>
    ...
    <div id="slideshow-container">
        ...
        <img class="mySlides fade" src="assets/imagens/slideshow/moedasslide.png" style="width:100%">
    </div>
    ...
    <nav id="other-pages">
        ...
        <a class="site-navigation" href="tutoriais.php">
            <img src="assets/imagens/banners-index/pesquisarbanner.webp" alt="Banner">
            <div>
                <h2>Como Jogar?</h2>
        ...
        <a class="site-navigation" href="f-mvv.php">
            <img src="assets/imagens/banners-index/slimeburaconegrobanner.webp" alt="Banner">
            <div>
        ...
        <a class="site-navigation" href="faq.php">
            <img src="assets/imagens/banners-index/slimeferreirobanner.webp" alt="Banner">
            <div>
        ...
        <a class="site-navigation" href="carrinho.php">
            <img src="assets/imagens/banners-index/apostartudobanner.webp" alt="Banner">
            <div>
